export const missions = [
  {
    ...
    evidence:
      'Operated Kubernetes infrastructure and implemented KEDA autoscaling for RabbitMQ at PicPay.',
    tools: 'Kubernetes · KEDA · AWS',
  ...
  },
  {
    ...
    evidence:
      'Standardized observability across 50+ AWS accounts and 3,000+ EC2 instances, migrating to Datadog at iFood.',
  ...
  },
  {
    ...
    fact: 'HITL',
    factLabel: 'humans stay in control',
    evidence:
      'Architected an AI agent engine with human approval, durable streaming, and an execution audit trail at Alloy / Kinter.',
    tools: 'LangGraph · Bedrock · Go · Python',
